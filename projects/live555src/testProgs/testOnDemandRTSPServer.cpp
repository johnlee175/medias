...
#define BASE_PATH "/Users/john/ClionProjects/live555/data/"
...
int main(int argc, char** argv) {
  ...
  // A MPEG-4 video elementary stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.m4e";
  ...
  // A H.264 video elementary stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.264";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A H.265 video elementary stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.265";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A MPEG-1 or 2 audio+video program stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.mpg";
...
//#define INTERLEAVE_ADUS 1
  ...
  //  see <http://www.live555.com/rtp-mp3/>)
  {
    ...
    char const* inputFileName = BASE_PATH"test.mp3";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A WAV audio stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.wav";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // An AMR audio stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.amr";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A 'VOB' file (e.g., from an unencrypted DVD):
  {
    ...
    char const* inputFileName = BASE_PATH"test.vob";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A MPEG-2 Transport Stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.ts";
    char const* indexFileName = BASE_PATH"test.tsx";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // An AAC audio stream (ADTS-format file):
  {
    ...
    char const* inputFileName = BASE_PATH"test.aac";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A DV video stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.dv";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A AC3 video elementary stream:
  {
    ...
    char const* inputFileName = BASE_PATH"test.ac3";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // A Matroska ('.mkv') file, with video+audio+subtitle streams:
  {
    ...
    char const* inputFileName = BASE_PATH"test.mkv";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // (Note: ".webm' files are special types of Matroska files, so we use the same code as the Matroska ('.mkv') file code above.)
  {
    ...
    char const* inputFileName = BASE_PATH"test.webm";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // An Ogg ('.ogg') file, with video and/or audio streams:
  {
    ...
    char const* inputFileName = BASE_PATH"test.ogg";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
  ...
  // (Note: ".opus' files are special types of Ogg files, so we use the same code as the Ogg ('.ogg') file code above.)
  {
    ...
    char const* inputFileName = BASE_PATH"test.opus";
    ServerMediaSession* sms
      = ServerMediaSession::createNew(*env, streamName, streamName,
				      descriptionString);
